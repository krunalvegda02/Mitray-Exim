  ...
  return (
    <div className="relative -mt-12 md:-mt-16 z-30 px-4 md:px-12">
      <div className="container mx-auto">
        <div className="glass-panel rounded-[2rem] md:rounded-full p-2 md:p-3 border-white/40 shadow-2xl overflow-hidden group bg-white/90">
          <div className="flex flex-col md:flex-row items-center">
            
            {/* LABEL INDICATOR */}
            <div className="flex items-center gap-4 px-8 py-4 bg-brand-navy rounded-[1.5rem] md:rounded-full text-white shrink-0 group-hover:bg-brand-gold transition-all duration-700 shadow-xl">
            ...
            {/* INSTITUTIONAL LOGO MARQUEE - REBUILT FOR 100% RELIABILITY */}
                    ...
                    <div key={i} className="flex items-center gap-4 group/logo cursor-crosshair">
                       ...
                       <div className="relative w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-xl bg-slate-50 border border-slate-100 group-hover/logo:bg-white group-hover/logo:shadow-lg transition-all duration-500 overflow-hidden">
                          ...
                          <div className="flex flex-col items-center justify-center">
                             ...
                             <div className={`w-4 h-0.5 mt-1 rounded-full ${p.color}`}></div>
                          </div>
                          {/* SECURITY GLOW */}
