      ...
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 relative z-10">
        ...
        <div className="relative mb-16 md:mb-24 group animate-reveal delay-400 opacity-0">
            ...
            {TESTIMONIALS.map((testimonial, index) => (
              <SwiperSlide key={index}>
                <div className="relative p-2 md:p-4">
                  <div className="relative glass-card bg-white/80 rounded-2xl md:rounded-[2rem] overflow-hidden border-white shadow-[0_30px_60px_-15px_rgba(44,74,94,0.1)] group/card p-2 md:p-6">
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 md:mb-10">
                        <div className="flex items-center gap-4 md:gap-6">
                          ...
                          <div className="text-left">
                            <h4 className="text-lg sm:text-xl md:text-3xl font-black text-brand-navy tracking-tighter mb-1">{testimonial.name}</h4>
          ...
          <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 z-20 flex justify-between pointer-events-none px-2 md:px-0">
            <button className="rev-prev w-8 h-8 md:w-16 md:h-16 rounded-xl bg-white shadow-xl border border-slate-100 flex items-center justify-center text-brand-navy hover:bg-brand-navy hover:text-white transition-all duration-700 pointer-events-auto md:-translate-x-6 group-hover:translate-x-0">
              <FiArrowLeft className="text-base md:text-xl" />
            </button>
            <button className="rev-next w-8 h-8 md:w-16 md:h-16 rounded-xl bg-white shadow-xl border border-slate-100 flex items-center justify-center text-brand-navy hover:bg-brand-navy hover:text-white transition-all duration-700 pointer-events-auto md:translate-x-6 group-hover:translate-x-0">
