      ...
      <div className="relative z-10 pt-12 md:pt-20 pb-20 md:pb-32 bg-[#F9FAFB]">
        <Container>
          ...
          <div className="mb-20 space-y-12">
             <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                   <div className="px-6 py-4 bg-white border-2 border-slate-100 flex items-center gap-4 shadow-sm">
                      <FiDatabase className="text-brand-gold" />
                      <div className="pr-4 border-r border-slate-100">
                         <p className="text-[10px] font-black text-brand-navy uppercase tracking-widest leading-none mb-1">Database Size</p>
                         <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">64 Assets</p>
                      </div>
                      <div className="pl-4">
                         <p className="text-[10px] font-black text-brand-navy uppercase tracking-widest leading-none mb-1">Status</p>
                         <p className="text-[10px] font-black text-emerald-500 uppercase tracking-widest leading-none flex items-center gap-1">
                            <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></div> Verified
                         </p>
                      </div>
                   </div>
                </div>
             ...
             <div className="flex flex-wrap gap-3 md:gap-4 border-b-2 border-slate-100 pb-8">
                {GALLERY_CATEGORIES.map((cat) => (
                   <button
                     ...
                     className={`flex items-center gap-3 px-6 py-4 text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-500 relative group ${
          ...
          <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
             {[
               { icon: <FiShield />, title: "Audit Ready", desc: "Every image represents a verified operational audit point." },
               { icon: <FiActivity />, title: "Live Sync", desc: "Our visual manifest is updated weekly across all global hubs." },
               { icon: <FiZap />, title: "High Fidelity", desc: "High-resolution documentation for institutional review." }
             ].map((item, i) => (
