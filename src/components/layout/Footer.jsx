          ...
          <div className="md:col-span-2 lg:col-span-4 space-y-6 md:space-y-8 animate-reveal opacity-0 delay-400">
            ...
            <div className="flex space-x-3">
              {[
                ...
                <a key={social.name} href={`https://${social.name}.com`} target="_blank" rel="noopener noreferrer" className="w-11 h-11 md:w-12 md:h-12 bg-white/5 hover:bg-brand-gold rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-1 group">
